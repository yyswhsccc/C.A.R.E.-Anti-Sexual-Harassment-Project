...
echo "create database moodle33 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci" | mysql -u root -pREPLACE_ME
echo "create database moodle35 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci" | mysql -u root -pREPLACE_ME
...
sed "s/password';/REPLACE_ME';/" -i config.php
sed "s|/home/example/moodledata';|/opt/data/moodle33';|" -i config.php

php admin/cli/install_database.php --adminpass=REDACTEDmoosh dev" --shortname="moosh dev" --adminemail=noreply@example.com --agree-license
